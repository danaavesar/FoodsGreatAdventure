...
$(window).load(function(){
  ...
  <!--//esoph -->
      ...
      $("#sphincterSVG").click(function(){
        if(sph_toggled) {
          ...
          $("#esoph").attr("src", "images/esoph/esoph_61.png");
          $("#entering_food").show();
          $("#sphinc_arrow2").show();
        	$('html,body').animate({scrollTop: 1650},750);
  		$('html,body').animate({scrollLeft: 850},800);
        }
          ...
          $("#stomach_info").show("slow", "swing");
           $("#sphinc_arrow2").hide();
          $('html,body').animate({scrollTop: 1850},800);
          setTimeout(function(){ 
            $("#stomach_info").hide(); 
            $("#stomach_info2").show();
            $("#hormone_arrows").show();
  	...
  	//animate when down arrow pressed
  	 $('body').keydown(function(e){
  		...
  		if(e.which == 68){
            ...
            //show parastalsis info
            $('#parastalsis_info').show("slow", "swing");
  	      ...
  	      if(dTriggered > 5 && dTriggered <8){
  	        scrollTopAmount += 60;
  	         $('html,body').animate({scrollTop: scrollTopAmount},800);
  	      }
  	        if(dTriggered > 8 && dTriggered <16){
  	        scrollTopAmount += 120;
  	         $('html,body').animate({scrollTop: scrollTopAmount + 80},800);
  	      }
  		}
        ...
        console.log(clicked);
    		...
    		if(toggled) {
                ...
                console.log(e.pageY);
        				//follow
          				$(hormone).css({
                    //top of page - stomach top and header height
          					"top":e.clientY,
          					"left":e.clientX
        				  }); 
  ...
  //press sspace bar shoot pepson
  $('body').keydown(function(k){

      k.preventDefault();
      k.stopPropagation();
      if(k.which == 32){ //space bar
        spaceBarPushed++;
        console.log('press');
        shootPepsin(mouseX, mouseY);
  ...
  $("#small_int_enter_button").click(function(e){
    ...
    $('html,body').animate({scrollLeft: 200},800);
  ...
  */
  ...
  //magnifyn
  $("#empty_magnifyn").draggable({
    drag: function(event, ui){
      $("#circle_empty").css({
        "left":ui.position.left,
        "top":ui.position.top
      })
      $("#magnifyn_background").css({
        "left":ui.position.left,
        "top":ui.position.top
      })
      $("#brush_border_info").show("swing","slow"); 
      $("#duo_info").hide();
